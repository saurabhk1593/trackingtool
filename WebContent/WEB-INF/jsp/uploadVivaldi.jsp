...
<script type="text/javascript">
    function ValidateInfo() {
         ...
         if(document.UploadVivaldiFrom.file.value=='')
         {
...
<body>
<form method="post" enctype="multipart/form-data" name="UploadVivaldiFrom">
<%
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <span class="bodytxt_grey">&gt;&gt; Upload Vivaldi Data</span></td>
              </tr>
              
              
              <tr>
                <td valign="top" class="pageheadertxt_maroon" align="center">Upload Vivaldi Information</td>
                </tr>
...
&nbsp&nbsp&nbsp&nbsp Project - Activity - Activity Desc - BuPo - BuPo Type - Number - BuPo Text - Date - Effort [h] - System - Comment - Reason (Actual > Planned) - User
<br>&nbsp</td>
</tr>
<tr><td>&nbsp</td></tr>
<tr>

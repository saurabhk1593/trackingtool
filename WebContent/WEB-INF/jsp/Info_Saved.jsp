...
<body>
<form method="post" name="saved_info_form">
<%
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="30" valign="middle" ><span class="breadcrum_red_txt">Tracking Tool Home</span><span class="bodytxt_grey">&gt;&gt; Status Message</span></td>
                </tr>
            ...
            <tr>
              ...
              <tr>
                ...
                <table width="97%" border="0" cellpadding="0" cellspacing="0" class="boxtable_greyborder_padding">
                  
                  <tr>
                    <td width="20%" height="30" align="center" class="bodytxt_black"><p>${message}</p></td>
                    </tr>
              ...
              <tr>
                ...
                <input name="Button2" type="button" class="redbutton1" onclick="JavaScript:homePageReport();" value="Ok" />
                </td>
              </tr>
              <tr>
                <td valign="top"><img src="images/spacer.gif" alt="spacer" width="1" height="10" /></td>

...
<%@page import="com.techm.trackingtool.util.TrackingToolConstant"%>
...
%>
<form method="post" name="CrEmailFrequencyForm" action="crconfigEmailFrequency.spring?task=configureEmail" >
...
<tr>
<td class=headerboldtxt_greybg_greyborder colspan="4">Configure Change Request E-mail settings</td>
</tr>
                  <tr>
...
<tr>
	...
	<c:if test="${model.emailFrequency.p1_interval =='Y'}">
     <%
     p1_interval="checked";%>
    </c:if>   
    <c:if test="${model.emailFrequency.p2_interval =='Y'}">
     <%
     p2_interval="checked";%>
    </c:if> 
    <c:if test="${model.emailFrequency.p3_interval =='Y'}">
     <%
     p3_interval="checked";%>
    </c:if> 
    <c:if test="${model.emailFrequency.p4_interval =='Y'}">
     <%
     p4_interval="checked";%>
    </c:if> 
...
<td class=bodytxt_black width="8%" align="left"><label id="sevType">${model.severity}</label></td>
                    ...
                    <input type="checkbox" name="frequency1" value="Y" <%=p1_interval%>/></td>
                    <td width="8%" align="left" class="bodytxt_black"><%=TrackingToolConstant.EMAIL_INTRVAL_PRIORITY_1 %> Hours</td>
                    <td width="3%" align="left" class="padding_left10_right3">
                    <input type="checkbox" name="frequency2" value="Y" <%=p2_interval%>/></td>
                    <td width="8%" align="left" class="bodytxt_black"><%=TrackingToolConstant.EMAIL_INTRVAL_PRIORITY_2 %> Hours</td>
                    <td width="3%" align="left" class="padding_left10_right3">
                    <input type="checkbox" name="frequency3" value="Y" <%=p3_interval%>/></td>
                    <td width="8%" align="left" class="bodytxt_black"><%=TrackingToolConstant.EMAIL_INTRVAL_PRIORITY_3 %> Hours</td>
					<td width="3%" align="left" class="padding_left10_right3">
					 <input type="checkbox" name="frequency4" value="Y" <%=p4_interval%>/></td>
                    <td width="8%" align="left" class="bodytxt_black"><%=TrackingToolConstant.EMAIL_INTRVAL_PRIORITY_4 %> Hours</td>

...
function ValidateInfo() {
		...
		if(document.forms[0].startDate.value==null || document.forms[0].endDate.value==null || document.forms[0].reasons=='')
         {
         alert("Please Enter all the fields");
         document.forms[0].elements["startDate"].focus();
         document.forms[0].elements["endDate"].focus();
         document.forms[0].elements["reasons"].focus();
         return false;
         }
...
%>
<form method="post" name="LeavePlanForm" action="Leave.spring?task=saveleave" >
...
<tr>
<td class=headerboldtxt_greybg_greyborder colspan="4">Associate Leave Plan</td>
</tr>
                  <tr>
                    <td height="10" colspan="4"><img src="images/spacer.gif" alt="spacer" width="1" height="6" /></td>
                    </tr>
<tr>
<td class=bodytxt_black width="20%" align="left">Enter Start Date</td>
                    <td><input type="text" id="strtDate" name="startDate"></td>
  					</td>
  					</tr>
  					<tr>
  					...
  					<td>
  					<select name="reasons">
  						<c:forEach var="leaveList" items="${model.Leaves}">
  							<option value="${leaveList.leaveReasonCode}">${leaveList.leaveReasonDesc}</option>
  						</c:forEach>
  					</select>

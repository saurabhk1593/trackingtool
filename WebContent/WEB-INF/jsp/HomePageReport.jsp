...
String border="0";
	...
	if(!severity.equals("")&& !month.equals("")){urlparameters="severity="+severity+"&month="+month;}
	else if(!age.equals("")&& !month.equals("")){
		urlparameters="age="+age+"&month="+month;
		if(!module.equals(""))
		{
			urlparameters="age="+age+"&module="+module+"&month="+month;
		}
		}
	else if(!status.equals("")&& !month.equals("")){urlparameters="status="+status+"&module="+module+"&month="+month;}
	else{urlparameters="age="+age+"&module="+module+"&month="+month;}
...
function download() {
	...
	document.HomePageForm.action="?task=getTTInfo&"+url;
...
function submitRemarks() {
	var url=document.HomePageForm.urlparameter.value;
	document.HomePageForm.excel.value="false";
...
<c:set var="ttInfo" value="${model.ttinfoMap}" />
<c:set var="urlInfo" value="${model.urlInfo}" />
...
<span class="breadcrum_red_txt">Linde Home</span><span class="bodytxt_grey">&gt;&gt; Home Page Report</span>
...
<td class=headerboldtxt_greybg_greyborder width="5%">Incident ID
</td>
<td class=headerboldtxt_greybg_greyborder width="12%" >Issue Description</td>
<td class=headerboldtxt_greybg_greyborder width="8%">Prioirity
</td>
...
<%int i=1; %>
<c:forEach var="ttInfo" items="${model.ttInfo}">

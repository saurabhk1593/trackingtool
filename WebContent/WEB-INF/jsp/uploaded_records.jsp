...
<body>
<form method="post" name="records_uploaded_form" >
<%
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="30" valign="middle" ><span class="breadcrum_red_txt">Linde Home</span><span class="bodytxt_grey">&gt;&gt; Upload TT Information</span></td>
                </tr>
              
              <tr>
                <td valign="top" class="pageheadertxt_maroon">Upload TT Information</td>
                </tr>
              <tr>
              ...
              <tr>
                <td align="center" valign="top"><table width="97%" border="0" cellpadding="0" cellspacing="0" class="boxtable_greyborder_padding">
                 ...
                 <c:if test="${message ==''}"> <tr>
                    <td width="20%" height="30" align="center" class="bodytxt_black"><p>The information related to the trouble tickets have been uploaded successfully.</p></td>
                    </tr>
                  </c:if>
                   <c:if test="${message !=''}"> <tr>
                    <td width="20%" height="30" align="center" class="bodytxt_red"><p>The information has not been uploaded due to error in data</p></td>
                    </tr>
                  </c:if> <tr>

...
<body>
<form method="post" name="deleted_user_form" >
<%
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="30" valign="middle" ><span class="breadcrum_red_txt">Tracking Tool Home</span><span class="bodytxt_grey">&gt;&gt; Delete User/Module</span></td>
                </tr>
              
              <tr>
                <td valign="top" class="pageheadertxt_maroon">Delete User/Module</td>
                </tr>
              <tr>
              ...
              <tr>
                <td align="center" valign="top"><table width="97%" border="0" cellpadding="0" cellspacing="0" class="boxtable_greyborder_padding">
                  ...
                  <tr>
                    <td width="20%" height="30" align="center" class="bodytxt_black"><p>The User/Module has has been deleted.</p></td>
                    </tr>

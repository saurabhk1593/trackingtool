...
<span class="breadcrum_red_txt">Tracking Tool Home</span><span class="bodytxt_grey">&gt;&gt; CR Review Report</span>
...
<c:set var="selectedFields" value="${crform.selectedFlds}" />
...
<tr>
	...
	<c:if test="${selectedFields.ChangeID =='ChangeID'}">
	<td class=headerboldtxt_greybg_greyborder width="5%">ChangeID</td>
	</c:if>
<c:if test="${selectedFields.BriefDes =='BriefDes'}">
	<td class=headerboldtxt_greybg_greyborder width="12%" >Brief Description</td>
	</c:if>
<c:if test="${selectedFields.Assignee =='Assignee'}">
	<td class=headerboldtxt_greybg_greyborder width="8%">Assignee</td>
	</c:if>
<c:if test="${selectedFields.Priority =='Priority'}">
	<td class=headerboldtxt_greybg_greyborder width="8%">Priority	</td>
	</c:if>
<c:if test="${selectedFields.AffectedCIs =='AffectedCIs'}">
	<td class=headerboldtxt_greybg_greyborder width="10%">Module	</td>
	</c:if>
<c:if test="${selectedFields.OpenDate =='OpenDate'}">
	<td class=headerboldtxt_greybg_greyborder width="8%">Open Date</td>
	</c:if>
<c:if test="${selectedFields.RequestedDate =='RequestedDate'}">
	...
	<c:if test="${selectedFields.Phase =='Phase'}">
	<td class=headerboldtxt_greybg_greyborder width="8%">CR Phase	</td>
	</c:if>

<c:if test="${selectedFields.EstimateEffort =='EstimateEffort'}">	
...
<td class=bggrey_bottombordergrey width=8%>${crInfo.requestedDate}<input type="hidden" name="crList[${status.index}].requestedDate" value="${crInfo.requestedDate}"/></td>
</c:if>

<td class=bggrey_bottombordergrey width=8%>${crInfo.targetDate}<input type="hidden" name="crList[${status.index}].targetDate" value="${crInfo.targetDate}"/></td>
...
<td class=bggrey_bottombordergrey width=8%>${crInfo.estimateEffort}<input type="hidden" name="crList[${status.index}].estimateEffort" value="${crInfo.estimateEffort}"/></td>
